...
const ensemblePicker = props => {
  const {onChange, collection, collectionTitle, collectionEnsembles, ensemble, classes} = props;
  ...
  const handleChange = id => {
    setMenu(null);
    navigate({search: '?collection=' + collection + '&ensemble=' + id});
...
export default connect(mapStateToProps)(withStyles(styles)(ensemblePicker));
