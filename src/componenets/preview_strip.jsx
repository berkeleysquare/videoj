...
import UpIcon from '@mui/icons-material/ArrowBackIos';
import DownIcon from '@mui/icons-material/ArrowForwardIos'
...
const NowPlayingButton = styled('div')({
...
const previewStrip = props => {
  const {items, id, assets, collection, ensemble} = props;
  ...
  return (
    <Panel>
      ...
      {(rightIndex < videoCount) &&
        <NavButton key="down" onClick={incrementIndex}>
          <DownIcon />
        </NavButton>}
    </Panel>
  );
